...
# pieces via --target.
Create-CfgFile "wasm64-wasip1.cfg" "wasm64-wasip1" "$ABS_TOOLCHAINSPATH_LLVM/wasm-sysroots/wasm-sysroot-mtg" $STANDARD_FLAGS_C $STANDARD_FLAGS_CPP "-fsanitize=memtag -fwasm-exceptions -mllvm -wasm-use-legacy-eh=false"
Create-CfgFile "wasm32-wasip1.cfg" "wasm32-wasip1" "$ABS_TOOLCHAINSPATH_LLVM/wasm-sysroots/wasm-sysroot-mtg" $STANDARD_FLAGS_C $STANDARD_FLAGS_CPP "-fsanitize=memtag -fwasm-exceptions -mllvm -wasm-use-legacy-eh=false"
...
Create-CfgFile "wasm64-wasip1-nomtg.cfg" "wasm64-wasip1" "$ABS_TOOLCHAINSPATH_LLVM/wasm-sysroots/wasm-sysroot" $STANDARD_FLAGS_C $STANDARD_FLAGS_CPP "-fwasm-exceptions -mllvm -wasm-use-legacy-eh=false"
Create-CfgFile "wasm32-wasip1-nomtg.cfg" "wasm32-wasip1" "$ABS_TOOLCHAINSPATH_LLVM/wasm-sysroots/wasm-sysroot" $STANDARD_FLAGS_C $STANDARD_FLAGS_CPP "-fwasm-exceptions -mllvm -wasm-use-legacy-eh=false"
