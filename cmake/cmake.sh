...
SYSROOT_SETTING="-DCMAKE_SYSROOT=$SYSROOTPATH -DCMAKE_FIND_ROOT_PATH=$SYSROOTPATH -DCMAKE_FIND_ROOT_PATH_MODE_PROGRAM=NEVER -DCMAKE_FIND_ROOT_PATH_MODE_LIBRARY=ONLY -DCMAKE_FIND_ROOT_PATH_MODE_INCLUDE=ONLY"
fi
fi
...
cmake "$TOOLCHAINS_BUILD/CMake" -GNinja -DCMAKE_BUILD_TYPE=Release -DCMAKE_C_COMPILER=$CC -DCMAKE_CXX_COMPILER=$CXX -DCMAKE_ASM_COMPILER=$CC \
	...
	-DCMAKE_INTERPROCEDURAL_OPTIMIZATION=On -DBUILD_TESTING=Off \
