...
BUILD_LLVM_FORCE_DISABLE_USE_SYMLINKS=0
...
if [[ "$OS" == "darwin"* ]]; then
    ...
    if [[ "$OS" == "windows" ]]; then
        ...
        if [[ "$ABI" == "android"* ]]; then
            ...
            BUILD_LLVM_FORCE_DISABLE_USE_SYMLINKS=1
        elif [[ "$ABI" == "musl" ]]; then
...
if [[ -n "$JOBS" ]] && [[ "$REDUCE_JOBS_BY_HALF" -eq 1 ]]; then
    JOBS=$(( JOBS / 2 > 0 ? JOBS / 2 : 1 ))
fi

WINDOWS_MSVC_SYSROOT_RUNTIMES_BUILD=$(( WINDOWS_MSVC_SYSROOT_RUNTIMES_LIBCXX_BUILD | WINDOWS_MSVC_SYSROOT_RUNTIMES_LIBCXX_BUILD ))
if [[ $WINDOWS_MSVC_SYSROOT_RUNTIMES_BUILD -ne 0 ]]; then
...
if(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.dll.a")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.dll.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzlib.dll.a")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzlib.dll.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzs.a")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzs.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzlibstatic.a")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libzlibstatic.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.a")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.tbd")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.tbd")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.so")
set(ZLIB_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libz.so")
...
if(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.a")
set(LIBXML2_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.dll.a")
set(LIBXML2_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.dll.a")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.tbd")
set(LIBXML2_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.tbd")
elseif(EXISTS "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.so")
set(LIBXML2_LIBRARY "\${CMAKE_FIND_ROOT_PATH}/lib/${TRIPLET}/libxml2.so")
...
if [[ BUILD_LLVM_HAVE_CXX_ATOMICS_WITHOUT_LIB -eq 1 ]]; then
cat << EOF >> "$currentpath/llvm.cmake"
set(HAVE_CXX_ATOMICS_WITHOUT_LIB On)
EOF
fi

if [[ BUILD_LLVM_HAVE_CXX_ATOMICS64_WITHOUT_LIB -eq 1 ]]; then
cat << EOF >> "$currentpath/llvm.cmake"
set(HAVE_CXX_ATOMICS64_WITHOUT_LIB On)
EOF
fi

if [[ BUILD_LLVM_FORCE_DISABLE_USE_SYMLINKS -eq 1 ]]; then
cat << EOF >> "$currentpath/llvm.cmake"
