...
set(LIBCXX_ADDITIONAL_LIBRARIES "\${LIBCXX_ADDITIONAL_COMPILE_FLAGS};-nostdinc++;-L${CURRENTTRIPLEPATH_RUNTIMES}/lib;-lc++")
...
set(CMAKE_RC_FLAGS "\${CMAKE_RC_FLAGS};\${CMAKE_SYSROOT}/include")
EOF
cat << EOF >> "$currentpath/llvm.cmake"
