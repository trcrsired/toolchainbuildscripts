...
CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" HOST=$GMPMPFRMPCHOSTALTERNATIVE NM="$GMPMPFRHOST-nm" RANLIB="$GMPMPFRHOST-ranlib" AR="$GMPMPFRHOST-ar" AS="$GMPMPFRHOST-as" STRIP="$GMPMPFRHOST-strip" $TOOLCHAINS_BUILD/gmp/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
...
CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" HOST=$GMPMPFRMPCHOSTALTERNATIVE NM="$GMPMPFRHOST-nm" RANLIB="$GMPMPFRHOST-ranlib" AR="$GMPMPFRHOST-ar" AS="$GMPMPFRHOST-as" STRIP="$GMPMPFRHOST-strip" $TOOLCHAINS_BUILD/mpfr/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
...
CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" HOST=$GMPMPFRMPCHOSTALTERNATIVE NM="$GMPMPFRHOST-nm" RANLIB="$GMPMPFRHOST-ranlib" AR="$GMPMPFRHOST-ar" AS="$GMPMPFRHOST-as" STRIP="$GMPMPFRHOST-strip" $TOOLCHAINS_BUILD/mpc/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
