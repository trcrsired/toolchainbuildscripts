...
GMP_CC_WORKS=On GMP_CXX_WORKS=On CFLAGS="-O2" CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" $TOOLCHAINS_BUILD/gmp/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
...
CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" HOST=$GMPMPFRMPCHOSTALTERNATIVE $TOOLCHAINS_BUILD/mpfr/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
...
CC=$GMPMPFRMPCHOST-gcc CXX=$GMPMPFRMPCHOST-g++ CC_FOR_BUILD=gcc CXX_FOR_BUILD=g++ CPP="$GMPMPFRMPCHOST-gcc -E" CXXCPP="$GMPMPFRMPCHOST-g++ -E" DLLTOOL="$GMPMPFRHOST-dlltool" HOST=$GMPMPFRMPCHOSTALTERNATIVE $TOOLCHAINS_BUILD/mpc/configure $GMPMPFRMPCCONFIGURE
if [ $? -ne 0 ]; then
