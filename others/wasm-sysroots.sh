...
EXTRA_LLVM_RUNTIME_COMPILE_FLAGS=""
...
EXTRA_LLVM_RUNTIME_COMPILE_FLAGS="-D_WASI_EMULATED_PTHREAD"
else
...
EH_FLAGS="-DLIBCXXABI_USE_LLVM_UNWINDER=On"
if [[ $EXTRA_LLVM_RUNTIME_COMPILE_FLAGS != "" ]]; then
EXTRA_LLVM_RUNTIME_COMPILE_FLAGS="-fwasm-exceptions $EXTRA_LLVM_RUNTIME_COMPILE_FLAGS"
else
EXTRA_LLVM_RUNTIME_COMPILE_FLAGS="-fwasm-exceptions"
fi
...
echo $EXTRA_LLVM_RUNTIME_COMPILE_FLAGS

if [[ $EXTRA_LLVM_RUNTIME_COMPILE_FLAGS != "" ]]; then

EH_FLAGS="-DLIBUNWIND_ADDITIONAL_COMPILE_FLAGS='$EXTRA_LLVM_RUNTIME_COMPILE_FLAGS' \
	-DLIBCXX_ADDITIONAL_COMPILE_FLAGS='$EXTRA_LLVM_RUNTIME_COMPILE_FLAGS' \
	-DLIBCXXABI_ADDITIONAL_COMPILE_FLAGS='$EXTRA_LLVM_RUNTIME_COMPILE_FLAGS' $EH_FLAGS"
