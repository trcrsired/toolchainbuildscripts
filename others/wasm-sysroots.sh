...
MYWASICOMMAND="$MYWASICOMMAND WASI_SNAPSHOT=${TARGETTRIPLE_ABI:4} LTO=full"
...
EH_FLAGS="-DLIBUNWIND_ADDITIONAL_COMPILE_FLAGS=-fwasm-exceptions \
	-DLIBCXX_ADDITIONAL_COMPILE_FLAGS=-fwasm-exceptions \
	-DLIBCXXABI_ADDITIONAL_COMPILE_FLAGS=-fwasm-exceptions -DLIBCXXABI_USE_LLVM_UNWINDER=On"
else
EHBUILDLIBS="libcxx;libcxxabi"
EH_FLAGS="-DLIBCXXABI_USE_LLVM_UNWINDER=Off"
fi
