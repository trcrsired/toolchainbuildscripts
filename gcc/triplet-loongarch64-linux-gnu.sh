...
#    "$GCC_BUILD_MAIN aarch64-w64-mingw32 aarch64-w64-mingw32"
...
#    "$GCC_BUILD_MAIN x86_64-w64-mingw32 aarch64-w64-mingw32"
#    "$GCC_BUILD_MAIN x86_64-w64-mingw32 i686-linux-musl"
)

if [[ "x$GCC_BUILD_WOA_HOST" == "xyes" ]]; then
GCCTRIPLETS+=(
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 x86_64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 aarch64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 loongarch64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 riscv64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 x86_64-elf"
    "$GCC_BUILD_MAIN aarch64-w64-mingw32 i586-msdosdjgpp"
...
GCC_EXTRA_HOSTS=(
    ...
    # aarch6464-linux-gnu hosts
    "$GCC_BUILD_MAIN aarch64-linux-gnu x86_64-w64-mingw32"
    "$GCC_BUILD_MAIN aarch64-linux-gnu x86_64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-linux-gnu loongarch64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-linux-gnu riscv64-linux-gnu"
    "$GCC_BUILD_MAIN aarch64-linux-gnu x86_64-elf"
    "$GCC_BUILD_MAIN aarch64-linux-gnu i586-msdosdjgpp"
    "$GCC_BUILD_MAIN aarch64-linux-gnu i686-w64-mingw32"
    "$GCC_BUILD_MAIN aarch64-linux-gnu x86_64-linux-musl"
    "$GCC_BUILD_MAIN aarch64-linux-gnu aarch64-linux-musl"
    "$GCC_BUILD_MAIN aarch64-linux-gnu i686-linux-musl"
)
